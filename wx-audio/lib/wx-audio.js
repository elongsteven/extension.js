var WxAudio = function(i) {
  ...
  var A = function() {
    ...
    return function(t, e, A) { return e && i(t.prototype, e), A && i(t, A), t }
  }();
  e(7);
  var o = e(1),
    n = e(0),
    a = function() {
      ...
      return A(i, [{
        ...
        value: function() {
          ...
          i.wxAudio.onplaying = function() {
          ...
          }, i.wxAudio.onpause = function() { i.isPlaying = !1, i.showLoading(!1), i.wxAudioStateImg.src = n }, i.wxAudio.onloadedmetadata = function() { i.durationT = i.wxAudio.duration, i.wxAudioDuration.innerText = i.formartTime(i.wxAudio.duration) }, i.wxAudio.onwaiting = function() { i.wxAudio.paused || i.showLoading(!0) }, i.wxAudio.onprogress = function() {
          ...
          }, i.wxAudio.onended = function() { i.opt.ended() }, i.wxAudio.ontimeupdate = function() {
            var t = new Date;
          ...
          }, i.wxAudioStateImg.onclick = function() { i.audioPlayPause() }, i.wxAudioOrigin.onmousedown = function(t) {
            i.isDrag = !0;
            ...
            }, i.wxAudioC.onmouseup = function() { i.isDrag && (i.isDrag = !1, i.wxAudio.currentTime = Math.floor(i.dragProgressTo / i.maxProgressWidth * i.durationT)) }, i.wxAudioC.onmouseleave = function() { i.isDrag && (i.isDrag = !1, i.wxAudio.currentTime = Math.floor(i.dragProgressTo / i.maxProgressWidth * i.durationT)) }
            ...
            }, i.wxAudioC.ontouchend = function() { i.isDrag && (i.isDrag = !1, i.wxAudio.currentTime = Math.floor(i.dragProgressTo / i.maxProgressWidth * i.durationT)) }
        ...
        key: "formartTime",
        value: function(i) {
          var t = function(i) { return (i = i.toString())[1] ? i : "0" + i },
            e = Math.floor(i / 60),
            A = Math.floor(i % 60);
          return t(e) + ":" + t(A)
        }
